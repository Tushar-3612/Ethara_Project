    ...
    <div className="relative flex min-h-screen items-center justify-center bg-gradient-to-br from-indigo-100 via-purple-50 to-pink-100 px-4 dark:from-gray-900 dark:via-purple-900/20 dark:to-indigo-900/30">
      ...
      >
        ...
        <div className="space-y-4">
          ...
          <div>
            <label className="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">Batch</label>
            <select
              className="w-full rounded-xl border border-gray-300 bg-white/50 px-4 py-2.5 text-gray-900 transition-all duration-200 focus:border-purple-500 focus:bg-white focus:outline-none focus:ring-2 focus:ring-purple-500/40 dark:border-gray-600 dark:bg-gray-900/50 dark:text-white dark:focus:bg-gray-900"
              name="batch"
              value={form.batch}
              onChange={handleChange}
              required
            ...
            >
              <option value="">
                {batchesLoading
                  ? "Loading batches..."
                  : batches.length === 0
                    ? "No batches available (ask admin)"
                    : "Select your batch"}
              </option>
              {batches.map((b) => (
        ...
        <p className="mt-6 text-center text-sm text-gray-600 dark:text-gray-400">
          ...
          <Link to="/login" className="font-semibold text-purple-600 transition-colors hover:text-purple-700 dark:text-purple-400 dark:hover:text-purple-300">
            Sign in
          </Link>
        </p>
      </form>
